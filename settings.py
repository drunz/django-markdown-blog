...
DATABASES = {
    'default': {
        ...
        'NAME': 'web_blog',                      # Or path to database file if using sqlite3.
...
PAGELET_BASE_TEMPLATES = (
    ('cms/plain.html', 'Plain'),
    ('cms/hero.html', 'Hero'),
    ('cms/header.html', 'Header'),
)
...
MEDIA_ROOT = '/var/websites/landing/media/'
...
STATIC_ROOT = '/var/websites/landing/static/'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/var/websites/landing/templates',
)
...
CACHES = {
    'defaultoff': {
        ...
        'LOCATION': '/var/tmp/django_landing_cache',
        #'TIMEOUT': 86400, # 24h
    },
    'default': {
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'PATH': '/var/tmp/landing_search_index',
    },
}
